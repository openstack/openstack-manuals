...
SERIES_INFO = collections.OrderedDict([
    ...
    ('victoria', SeriesInfo(date='October 2020', status='EOL')),
    ('wallaby', SeriesInfo(date='April 2021', status='EOL')),
    ('xena', SeriesInfo(date='October 2021', status='EOL')),
    ...
    ('2024.2', SeriesInfo(date='October 2024', status='EOL')),
